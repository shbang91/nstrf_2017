...
int main(int argc, char** argv){
    ...
    ros::Publisher ik_joint_state_pub  = nh.advertise<sensor_msgs::JointState>( "/val_ik_robot/joint_states", 100 );  
    ros::Publisher robot_joint_state_pub  = nh.advertise<sensor_msgs::JointState>( "/val_robot/joint_states", 100 );      

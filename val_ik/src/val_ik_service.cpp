...
/*    std::cout << "reach_start size:" << reach_start.size() << std::endl;
  ...
  //  constraint_array.push_back(&kc_rh_palm_quat);  
   ...
   // Publish Joint Message in ROS:
    ...
    joints_to_pub.push_back("torsoYaw");
    joints_to_pub.push_back("torsoPitch");
    joints_to_pub.push_back("torsoRoll");
    joints_to_pub.push_back("rightShoulderPitch");
    joints_to_pub.push_back("rightShoulderRoll");
    joints_to_pub.push_back("rightShoulderYaw");
    joints_to_pub.push_back("rightElbowPitch");
    joints_to_pub.push_back("rightForearmYaw");
    joints_to_pub.push_back("rightWristRoll");
    joints_to_pub.push_back("rightWristPItch");
    joints_to_pub.push_back("leftShoulderPitch");
    joints_to_pub.push_back("leftShoulderRoll");
    joints_to_pub.push_back("leftShoulderYaw");
    joints_to_pub.push_back("leftElbowPitch");
    joints_to_pub.push_back("leftForearmYaw");
    joints_to_pub.push_back("leftWristRoll");
    joints_to_pub.push_back("LeftWristPitch");
    joints_to_pub.push_back("rightHipYaw");
    joints_to_pub.push_back("rightHipRoll");
    joints_to_pub.push_back("rightHipPitch");
    joints_to_pub.push_back("rightKneePitch");
    joints_to_pub.push_back("rightAnklePitch");
    joints_to_pub.push_back("rightAnkleRoll");
    joints_to_pub.push_back("leftHipYaw");
    joints_to_pub.push_back("leftHipRoll");
    joints_to_pub.push_back("leftHipPitch");
    joints_to_pub.push_back("leftKneePitch");
    joints_to_pub.push_back("leftAnklePitch");
    joints_to_pub.push_back("leftAnkleRoll");  


    for(size_t i = 0; i < joints_to_pub.size(); i++ ){
